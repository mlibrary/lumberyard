...
var treeFactory, parseAllChildren, sumDenominators, childrenOf,
  logMessage;

treeFactory = function(inputObject) {
  var tree, denominator, children, isComplete;
  ...
  tree.complete = function(inputArray) {
    var message = logMessage(inputArray);
