...
log_message = function(mutable_array) {
  var timestamp, code, message;

  timestamp = mutable_array.shift();
  code = mutable_array.shift();
  message = mutable_array.pop();
};
